package com.tecno.corralito.models.response.productoEspesifico.productoEsp;
...
import com.tecno.corralito.models.response.usuarios.comercio.ComercioResponseDto;
import lombok.*;
